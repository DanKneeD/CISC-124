...
public final class StdDraw
  ...
  public static void setCanvasSize(int w, int h) {
    if (w < 1 || h < 1) throw new RuntimeException(
  ...
  public static void point(double x, double y) {
    ...
    if (r <= 1) pixel(x, y); else offscreen.fill(
      new Ellipse2D.Double(xs - r / 2, ys - r / 2, r, r)
    );
    draw();
  }
  ...
  public static void ellipse(
    ...
    if (semiMajorAxis < 0) throw new RuntimeException(
      "ellipse semimajor axis can't be negative"
    );
    if (semiMinorAxis < 0) throw new RuntimeException(
  ...
  public static void rectangle(
    ...
    if (halfWidth < 0) throw new RuntimeException(
      "half width can't be negative"
    );
    if (halfHeight < 0) throw new RuntimeException(
      "half height can't be negative"
    );
    double xs = scaleX(x);
    double ys = scaleY(y);
  ...
  private static Image getImage(String filename) {
    ...
    if (
      (icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)
    ) {
      try {
  ...
  public static void picture(double x, double y, String s) {
    ...
    if (ws < 0 || hs < 0) throw new RuntimeException(
      "image " + s + " is corrupt"
    );
